...
<head>
  ...
  <title>Rokia Dev - personal portfolio</title>

  <!-- 
    - favicon
  -->
  <link rel="shortcut icon" href="img/code-file.svg" type="image/svg+xml">
...
<body id="top" class="dark_theme">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <h1 class="h1 logo">
        <a href="#home">
          <img src="img/code-file.svg" class="logo-img">
          Rokia<span>.</span>
        </a>
      </h1>
      ...
      <button class="nav-toggle-btn" aria-label="Toggle Menu" title="Toggle Menu" data-nav-toggle-btn id="nav-toggle-btn">
        <span class="one"></span>
        <span class="two"></span>
    ...
    <article class="container">
      ...
      <section class="hero" id="home">
        ...
        <figure class="hero-banner">
          <div class="blob"></div>
          <!-- <picture class="blob">
            <img src="img/first.png" alt="" class="first w-100">
          </picture> -->
        ...
        <ul class="stats-list">
          ...
          <li>
            <a href="#" class="stats-card">
              ...
              <div class="card-icon">
                <img src="img/stats-card_icon-1.png" alt="Badge icon">
              </div>
          ...
          <li>
            <a href="#" class="stats-card">
              ...
              <div class="card-icon">
                <img src="img/stats-card_icon-2.png" alt="Checkmark icon">
              </div>
          ...
          <li>
            <a href="#" class="stats-card">
              ...
              <div class="card-icon">
                <img src="img/stats-card_icon-3.png" alt="Peoples rating icon">
              </div>

              <h2 class="h2 card-title">
                45+ <strong>Happy Clients</strong>
              </h2>
      ...
      <section class="about" id="about">
        ...
        <figure class="about-banner">
          ...
          <!-- <img src="img/first.png" alt="A woman in a alice blue shirt with a thinking expression" class="first w-100"> -->
        </figure>
        ...
        <div class="about-content section-content">
          ...
          <p class="section-text">
            Hi! I’m Rokia Bouchair, and I’m a developer who has passion for building clean web applications with intuitive
          ...
          <ul class="tools-list">
            ...
            <li>
              <div class="skill-card">
                ...
                <div class="card-icon">
                  <img src="img/github.png" alt="Git Hub logo">
                </div>
              </div>
            </li>
        ...
        <ul class="project-list">
          ...
          <li>
            <a href="#" class="project-card">
              ...
              <figure class="card-banner">
                <img src="img/project-1.png" class="w-100" alt="A macintosh on a yellow background.">
              </figure>
          ...
          <li>
            <a href="#" class="project-card">
              ...
              <figure class="card-banner">
                <img src="img/project-2.png" class="w-100" alt="On a Blue background, a Wacom and a mouse.">
              </figure>
          ...
          <li>
            <a href="#" class="project-card">
              ...
              <figure class="card-banner">
                <img src="img/project-3.png" class="w-100"
          ...
          <li>
            <a href="#" class="project-card">
              ...
              <figure class="card-banner">
                <img src="img/project-4.png" class="w-100"
          ...
          <li>
            <a href="#" class="project-card">
              ...
              <figure class="card-banner">
                <img src="img/project-5.png" class="w-100"
          ...
          <li>
            <a href="#" class="project-card">
              ...
              <figure class="card-banner">
                <img src="img/project-6.png" class="w-100"
          ...
          <li>
            <a href="#" class="project-card">
              ...
              <figure class="card-banner">
                <img src="img/project-7.png" class="w-100"
      ...
      <section class="project portfolio" data-page="portfolio" id="portfolio">
        ...
        <div class="projects">
          ...
          <div class="filter-select-box">
            ...
            <ul class="select-list">
              ...
              <li class="select-item">
                <button data-select-item data-filter-btn>All</button>
              </li>

              <li class="select-item">
                <button data-select-item data-filter-btn>Web Design</button>
              </li>

              <li class="select-item">
                <button data-select-item data-filter-btn>Applications</button>
              </li>

              <li class="select-item">
                <button data-select-item data-filter-btn>Web development</button>
              </li>
          ...
          <ul class="project-list">
            ...
            <li class="project-item  active" data-filter-item data-category="web development">
              <a href="https://coffee-shope-hr.netlify.app">
                ...
                <figure class="project-img">
                  ...
                  <img src="img/Responsive coffee website.png" alt="finance" loading="lazy">
                </figure>

                <h3 class="project-title">Coffee Shope</h3>
            ...
            <li class="project-item  active" data-filter-item data-category="web development">
              <a href="#">
                ...
                <figure class="project-img">
                  ...
                  <img src="img/Responsive sushi website.png" alt="orizon" loading="lazy">
                </figure>

                <h3 class="project-title">Japanese Sushi</h3>
            ...
            <li class="project-item  active" data-filter-item data-category="web design">
              <a href="#">
                ...
                <figure class="project-img">
                  ...
                  <img src="img/Responsive watches website.png" alt="fundo" loading="lazy">
                </figure>

                <h3 class="project-title">Rolex Watches</h3>
            ...
            <li class="project-item  active" data-filter-item data-category="applications">
              <a href="https://tasty-restaurant-hr.netlify.app/">
                ...
                <figure class="project-img">
                  ...
                  <img src="img/Tasty Restaurant.png" alt="brawlhalla" loading="lazy">
                </figure>

                <h3 class="project-title">Tasty Restaurant</h3>
            ...
            <li class="project-item  active" data-filter-item data-category="web design">
              <a href="https://anon-state.netlify.app">
                ...
                <figure class="project-img">
                  ...
                  <img src="img/Template One.png" alt="dsm." loading="lazy">
                </figure>

                <h3 class="project-title">Anon State</h3>
            ...
            <li class="project-item  active" data-filter-item data-category="web design">
              <a href="https://jack-daniel-s-portfolio.netlify.app/">
                ...
                <figure class="project-img">
                  ...
                  <img src="img/Jack Daniel Portfolio.png" alt="metaspark" loading="lazy">
                </figure>

                <h3 class="project-title">Jack Daniel Portfolio</h3>
            ...
            <li class="project-item  active" data-filter-item data-category="web development">
              <a href="https://jde-cafeteria.netlify.app/">
                ...
                <figure class="project-img">
                  ...
                  <img src="img/Jacobs Douwe Egberts Coffee.png" alt="summary" loading="lazy">
                </figure>

                <h3 class="project-title">JDE Cafeteria</h3>
            ...
            <li class="project-item  active" data-filter-item data-category="applications">
              <a href="#">
                ...
                <figure class="project-img">
                  ...
                  <img src="img/Green Portfolio.png" alt="task manager" loading="lazy">
                </figure>

                <h3 class="project-title">Emelia Personal Website</h3>
            ...
            <li class="project-item  active" data-filter-item data-category="web development">
              <a href="https://mealty-fast-food.netlify.app/">
                ...
                <figure class="project-img">
                  ...
                  <img src="img/Mealty Fast Food.png" alt="arrival" loading="lazy">
                </figure>

                <h3 class="project-title">Mealty Fast Food</h3>
            ...
            <li class="project-item  active" data-filter-item data-category="web development">
              <a href="https://knoledge-school.netlify.app/">
                ...
                <figure class="project-img">
                  ...
                  <img src="img/Knowledge.png" alt="arrival" loading="lazy">
                </figure>

                <h3 class="project-title">Knoledge School</h3>
          ...
          <ul class="contact-list">
            ...
            <li class="contact-list-item">
              ...
              <div class="wrapper">
                ...
                <a href="tel:01234567789" class="contact-info">(213) 234 567 789</a>
            ...
            <li class="contact-list-item">
              ...
              <div class="wrapper">
                ...
                <a href="m20196@constantine3.dz" class="contact-info">m20196@constantine3.dz</a>
  ...
  <footer class="footer">
    <div class="container">
      ...
      <p class="copyright">
        ...
        <a href="https://html.design/">Rokia Dev.</a><br><br>
      </p>
